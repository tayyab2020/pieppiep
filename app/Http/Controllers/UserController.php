...
class UserController extends Controller
{
    ...
    public function GetCustomerEmail(Request $request)
    {
        ...
        if(!$quotation_mail_subject_template)
        {
            $quotation_mail_subject_template = 'Offerte: {offerte_nummer}';
        }

        if(!$quotation_mail_body_template)
        {
        ...
        $quotation_mail_body_template = str_replace('{onderteken_link}','Click <a href="'.$link.'">here</a> to accept this quote directly online',$quotation_mail_body_template);
