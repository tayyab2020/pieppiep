...
<div class="hero-area overlay" style="background-image: url({{asset('assets/images/'.$gs->bgimg)}});z-index: auto;color: black;">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="donors-header text-center" style="color: black;margin-left: 130px;">{{$lang->fht}}</h1>
                        <div class="hero-form">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="team_common">
                            ...
                            <div class="member_img" style="width: 50%;border: 0;display: inline-block;height: 210px;">
                                    ...
                                    <img src="{{ $ruser->photo ? asset('assets/images/'.$ruser->photo):'https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcSCM_FnlKpZr_N7Pej8GA40qv63zVgNc0MFfejo35drsuxLUcYG'}}" alt="member image" style="width: 65%;height: 180px;padding: 0px;border-radius: 100%;border:1px solid lightgrey;margin: auto;display: block;margin-top: 20px;">
                            </div>
                            ...
                            <div class="member_info text-center pos_relative" style="height: 190px;">
                                ...
                                <div style="width: 33%;float: left;margin-top: 20px;">
                                    ...
                                    <div class="change1" style="padding: 10px;font-size: 17px;">@if($ruser->experience_years) {{$ruser->experience_years}} @if($ruser->experience_years > 1) Years @else Year @endif @else N/A @endif </div>
