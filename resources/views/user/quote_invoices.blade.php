                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div style="margin: 20px 0;" class="row">
                                <div style="display: flex;flex-direction: column;align-items: flex-start;" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <label>Subject:</label>
                                    <input value="{{$quotation_email_template ? $quotation_email_template->subject : 'Offerte: {offerte_nummer}'}}" type="text" name="mail_subject" class="form-control">
                                </div>
                            </div>
