                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="add-product-box">
                                    ...
                                    <div style="margin-top: 30px;" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <h5 style="color: #ff4238;margin-bottom: 20px;">Note: If you remove or add a type than apparently its associated brand will also be added or removed from your catalogue as both brands and types are linked with each other. Similarly when you add a new brand of other supplier in your catalogue than its associated types are automatically added in your types list.</h5>

                                    </div>

                                    <form class="form-horizontal" action="{{route('supplier-types-store')}}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="control-label col-sm-4" for="blood_group_slug">Types</label>

                                            <div class="col-sm-6">

                                                <select style="height: 100px;" class="form-control" name="supplier_types[]" id="supplier_types" multiple>
                                                    ...
                                                    @foreach($types as $cat)
                                                        ...
                                                        <?php
                                                            ...
                                                            if($cat->other_suppliers)
                                                                {
                                                                    $suppliers = explode(',',$cat->other_suppliers);
                                                                }
                                                            else
                                                                {
                                                                    $suppliers = array();
                                                        ...
                                                        <option {{(in_array($user_id, $suppliers) ? 'selected' : null)}} value="{{$cat->type_id}}">{{$cat->type}}</option>
