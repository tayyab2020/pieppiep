                                    ...
                                    <form class="form-horizontal" action="{{route('supplier-brands-store')}}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <select style="height: 100px;" class="form-control" name="supplier_brands[]" id="supplier_brands" multiple>
                                                    ...
                                                    @foreach($brands as $cat)
                                                        ...
                                                        <option {{(in_array($user_id, $suppliers) ? 'selected' : null)}} value="{{$cat->id}}">{{$cat->cat_name}}</option>
