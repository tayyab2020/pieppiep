                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="add-product-box">
                                    <div class="add-product-header products">
                                        ...
                                        <a href="{{route('admin-attribute-create')}}" class="btn add-newProduct-btn"><i class="fa fa-plus"></i> Add New Attribute</a>
                                                ...
                                                <table id="example"
                                                    ...
                                                    @foreach($attributes as $cat)
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td>{{$cat->title}}</td>
                                                            <td>{{$cat->is_required ? 'Yes' : 'No'}}</td>
                                                            <td>{{$cat->is_unique ? 'Yes' : 'No'}}</td>
                                                            <td>{{$cat->cat_name}}</td>
                                                            <td>

                                                                <a href="{{route('admin-attribute-edit',$cat->id)}}" class="btn btn-primary product-btn"><i class="fa fa-edit"></i> Edit</a>
                                                                <a href="{{route('admin-attribute-delete',$cat->id)}}" class="btn btn-danger product-btn"><i class="fa fa-trash"></i> Remove</a>
