                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="add-product-box">
                                    <div class="add-product-header products">
                                        <h2>Sub Products</h2>
                                        <a href="{{route('admin-sub-products-create')}}" class="btn add-newProduct-btn"><i class="fa fa-plus"></i> Add New</a>
                                    </div>
                                    <hr>
                                    <div>
                                                ...
                                                <table id="example" class="table table-striped table-hover products dt-responsive dataTable no-footer dtr-inline" role="grid" aria-describedby="product-table_wrapper_info" style="width: 100%;" width="100%" cellspacing="0">
                                                    ...
                                                    @foreach($sub_products as $item)
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td>{{$item->title}}</td>
                                                            <td>
                                                                <a href="{{route('admin-sub-products-edit',$item->id)}}" class="btn btn-primary product-btn"><i class="fa fa-edit"></i> Edit</a>
                                                                <a href="{{route('admin-sub-products-delete',$item->id)}}" class="btn btn-danger product-btn"><i class="fa fa-trash"></i> Remove</a>
                                                            </td>
                                                        </tr>
                                                    @endforeach
                                                    </tbody>
