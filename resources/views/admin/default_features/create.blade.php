                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="add-product-box">
                                    ...
                                    <div class="add-product-header">
                                        ...
                                        <a href="{{route('default-features-index')}}" class="btn add-back-btn"><i class="fa fa-arrow-left"></i> {{__('text.Back')}}</a>
                                    </div>
...
<script type="text/javascript">
    ...
    $(document).on('click', '.add-row', function () {
        ...
        $(".options-table table tbody").append('<tr data-id="'+feature_row+'">\n' +
            ...
            '                                                                                        <td style="text-align: center;">\n' +
            '\n' +
            '                                                                                           <span data-id="'+feature_row+'" id="next-row-span" class="tooltip1 sub-category-row" style="cursor: pointer;font-size: 20px;">\n' +
            '                                                                                               <i id="next-row-icon" class="fa fa-fw fa-shield"></i>\n' +
            '                                                                                           </span>\n' +
            '\n' +
